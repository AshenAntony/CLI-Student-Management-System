...
class Coursework {
	...
	System.out.println("------------------------------------------------------------");
        System.out.println("| Student ID\t|Student Name\t|DBMS Marks\t|PRF Marks|");
        System.out.println("------------------------------------------------------------");
		...
		if (index != 0) {
			for (int j = 0; j < index; j++) {
				System.out.println( "|"+ studentId[j] + " \t\t| "+ studentName[j]+ " \t| " + dbmsMarks[j]+   " \t\t| " +
						prfMarks[j]+"       |");
			}
            System.out.println("------------------------------------------------------------");
            System.out.println();
			...
			for (int i = 0; i < prfMarks.length; i++) {
				System.out.println("|"+studentId[i]+" \t\t| "+ studentName[i]+" \t\t| " + dbmsMarks[i]+ " \t\t| " +prfMarks[i]+"      |");
			}
            System.out.println("------------------------------------------------------------");
            System.out.println();
		}
	...
	public static void bestInPRF() {
		...
		System.out.println("------------------------------------------------------------");
        System.out.println("| Student ID\t|Student Name\t|PRF Marks\t|DBMS Marks|");
        System.out.println("------------------------------------------------------------");
		...
		if (index != 0) {
			for (int j = 0; j < index; j++) {
				System.out.println( "|"+ studentId[j]+ " \t\t| "+ studentName[j] +" \t| " + prfMarks[j] +"\t| "+
						dbmsMarks[j]+"       |");
			}
			System.out.println("------------------------------------------------------------");
            System.out.println();
			...
			for (int i = 0; i < prfMarks.length; i++) {
				System.out.println( "|"+studentId[i] +" \t\t| "+ studentName[i] +" \t\t| "+ prfMarks[i] +"\t| "+
						dbmsMarks[i]+"       |");
			}
			System.out.println("------------------------------------------------------------");
            System.out.println();
	...
	public static void printStudentRanks() {
		...
		if (index != 0) {
			for (int j = 0; j < index; j++) {
				System.out.println("|"+j + 1 +"\t|"+ studentId[j] +"\t\t|"+ studentName[j] +"\t\t|"+ total[j] + "\t\t|"+
						(double) total[j] / 2+"         |");
			}
            System.out.println("-----------------------------------------------------------------------");
			...
			for (int i = 0; i < prfMarks.length; i++) {
				System.out.println("|"+i + 1 +"\t|"+ studentId[i] +"\t\t|"+ studentName[i] +"\t\t|"+ total[i] + "\t\t|"+
						(double) total[i] / 2+"         |");
			}
            System.out.println("-----------------------------------------------------------------------");
		}
	...
	public static void printStudentDetails() {
		...
		L1: do {
			...
			if (index == -1) {
				...
				System.out.println("|Database Manegment System Marks   |" + dbmsMarks[index]);
				System.out.println("|Total Marks			   |" + total[index]);
				System.out.println("|Avg. Marks  			   |"+(double) total[index] / 2);
		...
		C1: do {
			...
			C2:do {
				...
				switch (option) {
					...
					case 'n': case 'N': clearConsole(); run = false; mainMenu(); break;
					default: System.out.println("\nInvalid Input. Try again."); continue C2;
				}
			} while (true);
		} while (run);
	...
	public static void sortStudentsByDBMS() {
		// sort dbms marks in descending order
		for (int i = prfMarks.length - 1; i > 0; i--) {
			for (int j = 0; j < i; j++) {
